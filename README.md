...
│   │       │   │   ├── LclUclResult.java         # LCL/UCL calculation results
...
│       │   │   └── PlaywrightFactory.java        # Browser and page management
...
│       │       │   ├── GetAggregateValueOfKpi.java # Get aggregate KPI values
│       │       │   ├── GetChartDataApi.java       # Chart data API test
│       │       │   ├── GetEquipment.java          # Equipment API test
│       │       │   ├── GetKpiData.java            # KPI data API test
│       │       │   ├── GetKpiLclUclValue.java     # KPI LCL/UCL value test
│       │       │   ├── GetKpiRequest.java         # KPI request test
│       │       │   ├── GetRawParamLclUclValue.java # Raw parameter LCL/UCL test
│       │       │   ├── GetRawParamRequest.java    # Raw parameter request test
│       │       │   └── GetRawParameterData.java   # Raw parameter data test
│       │       └── web/              # Web tests
